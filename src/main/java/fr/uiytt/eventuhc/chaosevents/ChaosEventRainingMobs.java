...
public class ChaosEventRainingMobs extends ChaosEvent {
	...
	public ChaosEventRainingMobs() {
		super("RainingMobs", Material.WATER_BUCKET, 32, Type.NORMAL, new String[]{"Pluie de mobs :D"},180);
	...
	protected void onEnable() {
		super.onEnable();
		Bukkit.broadcastMessage(ConfigManager.EVENT_HEADER + "It's Raining Mobs");
		new BukkitRunnable() {

...
public class ChaosEventWaterIsPoison extends ChaosEvent {
	...
	public ChaosEventWaterIsPoison() {
		super("Poisonous water", Material.FERMENTED_SPIDER_EYE, 7, Type.NORMAL, new String[]{"Les joueurs recoivent poison dans l'eau"});
	}
	
	@Override
	protected void onEnable() {
		super.onEnable();
		Bukkit.broadcastMessage(ConfigManager.EVENT_HEADER + "L'eau est maintenant radioactive (enfin elle donne poison)");
		new BukkitRunnable() {
